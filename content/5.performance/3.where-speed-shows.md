...
| ---------------------- | ----------: | ------: |
| SELECT by primary key  | **1.15 ms** | 1.85 ms |
| COUNT with filter      | **0.83 ms** | 1.09 ms |
| Transaction (2 writes) | **2.15 ms** | 4.70 ms |
...
1. **Same database, same endpoint.** Point both tools at the _exact_ same host.
